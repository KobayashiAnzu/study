...
<form:form action="" method="post" modelAttribute="diary" class="d-flex flex-row justify-content-center align-items-center">
			...
			<p>タイトル：<input type="text" name="title" class="title"/>
             ...
             <option value="&#x1f370;">&#x1f370;</option>
			   ...
			   <p><textarea id="textarea-with-border" class="form-control" rows=10 cols=45 name="contents">
			  </textarea></p>

			  <p><input type="submit" value="投稿" class="btn-square-so-pop"/></p>
             </div>
 </form:form>
...
<c:forEach items="${koreans}" var="korean">
		<tr>
			...
			<td><a href="korean/edit/<c:out value="${korean.id}" />"><img src="${images}/editk.png" alt="編集" /></a></td>
		    <td><a href="korean/delete/<c:out value="${korean.id}" />"><img src="${images}/deletek.png" alt="削除" /></a></td>
		</tr>
</c:forEach>
	</table>
